    ...
    for index_char, char in enumerate(item):
        if char in numeros:
            ...
            if index_char != len(item) - 1:
                if linea_arriba[index_char + 1] in simbolos:
                    valido = True
                    coord_gear = (index_item - 1, index_char + 1)

                if linea_abajo[index_char + 1] in simbolos:
                    valido = True
                    coord_gear = (index_item + 1, index_char + 1)

                if item[index_char + 1] in simbolos:
                    valido = True
                    coord_gear = (index_item, index_char + 1)
            ...
            if linea_arriba[index_char] in simbolos:
                valido = True
                coord_gear = (index_item - 1, index_char)

            if linea_abajo[index_char] in simbolos:
                valido = True
                coord_gear = (index_item + 1, index_char)
        ...
        if char == "." or char in simbolos or index_char == len(item) - 1:
            if valido:
                try:
                    gears[coord_gear].append(int(numero_actual))
                except:
                    gears[coord_gear] = [int(numero_actual)]
            numero_actual = ""
            valido = False
