...
for line in input:
    ...
    for char in line:
        if char == "S":
            linea_distancia.append(0)
        else:
            linea_distancia.append(-1)
    distancias.append(linea_distancia)

for i in range(len(distancias) * len(distancias[0])):
    for index_linea, line in enumerate(distancias):
        for index_distancia, distancia in enumerate(line):
            if distancia != -1:
                try:
                    if input[index_linea - 1][index_distancia] in arriba and distancias[index_linea - 1][
                        index_distancia] == -1:
                        distancias[index_linea - 1][index_distancia] = distancia + 1
                except:
                    None

                try:
                    if input[index_linea + 1][index_distancia] in abajo and distancias[index_linea + 1][
                        index_distancia] == -1:
                        distancias[index_linea + 1][index_distancia] = distancia + 1
                except:
                    None
                ...
                try:
                    if input[index_linea][index_distancia - 1] in izquierda and distancias[index_linea][
                        index_distancia - 1] == -1:
                        distancias[index_linea][index_distancia - 1] = distancia + 1
                except:
                    None

                try:
                    if input[index_linea][index_distancia + 1] in derecha and distancias[index_linea][
                        index_distancia + 1] == -1:
                        distancias[index_linea][index_distancia + 1] = distancia + 1
                except:
                    None

print(max(map(max, distancias)))
