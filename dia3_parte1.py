...
for index_item, item in enumerate(entrada):
    numero_actual = ""
    valido = False
    for index_char, char in enumerate(item):
        if char in numeros:
            ...
            try:
                linea_arriba = entrada[index_item - 1]
            except:
                linea_arriba = linea_puntos

            try:
                linea_abajo = entrada[index_item + 1]
            except:
                linea_abajo = linea_puntos

            if index_char == len(item)-1:
                if linea_arriba[index_char] in simbolos or linea_arriba[index_char - 1] in simbolos:
                    valido = True

                if linea_abajo[index_char] in simbolos or linea_abajo[index_char - 1] in simbolos:
                    valido = True

                if item[index_char - 1] in simbolos:
                    valido = True

            elif index_char == 0:
                if (linea_arriba[index_char] in simbolos or
                        linea_arriba[index_char + 1] in simbolos):
                    valido = True

                if (linea_abajo[index_char] in simbolos or
                        linea_abajo[index_char + 1] in simbolos):
                    valido = True
                ...
                if (linea_arriba[index_char] in simbolos or linea_arriba[index_char - 1] in simbolos or
                        linea_arriba[index_char + 1] in simbolos):
                    valido = True

                if (linea_abajo[index_char] in simbolos or linea_abajo[index_char - 1] in simbolos or
                        linea_abajo[index_char + 1] in simbolos):
                    valido = True

                if item[index_char - 1] in simbolos or item[index_char + 1] in simbolos:
                    valido = True

        if char == "." or char in simbolos or index_char == len(item)-1:
